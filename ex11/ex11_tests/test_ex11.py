...
def test_build_tree1():
    ...
    records = parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/ex11_tests/tiny_data2.txt")
    tree1 = build_tree(records, ["headache", "fever"])

    assert "meningitis" == tree1.root.positive_child.positive_child.data
    assert "influenza" == tree1.root.positive_child.negative_child.data
    assert "cold" == tree1.root.negative_child.positive_child.data
    assert "healthy" == tree1.root.negative_child.negative_child.data

def test_build_tree2():

    records = parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/ex11_tests/small_data1.txt")
    tree2 = build_tree(records, ["headache", "fever"])

    assert "influenza" == tree2.root.positive_child.positive_child.data
    assert "cold" == tree2.root.positive_child.negative_child.data
    assert "strep" == tree2.root.negative_child.positive_child.data
    assert "healthy" == tree2.root.negative_child.negative_child.data

def test_build_tree3():

    records = parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/ex11_tests/medium_data1.txt")
    tree3 = build_tree(records, ["fever", "cough"])

    assert "influenza" == tree3.root.positive_child.positive_child.data
    assert "meningitis" == tree3.root.positive_child.negative_child.data
    assert "cold" == tree3.root.negative_child.positive_child.data
    assert "healthy" == tree3.root.negative_child.negative_child.data

def test_build_tree4():

    records = parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/ex11_tests/medium_data2.txt")
    tree4 = build_tree(records, ["fever", "cough"])

    assert "influenza" == tree4.root.positive_child.positive_child.data
    assert "strep" == tree4.root.positive_child.negative_child.data
    assert "cold" == tree4.root.negative_child.positive_child.data
    assert "healthy" == tree4.root.negative_child.negative_child.data

def test_optimal_tree1():
    records = parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/ex11_tests/test_optimal_tree1.txt")
    tree = optimal_tree(records, ["cough", "fever", "headache"], 2)
    
    assert "cough" == tree.root.data or "fever" == tree.root.data
    assert "cough" == tree.root.positive_child.data or "fever" == tree.root.positive_child.data

def test_optimal_tree2():
    records = parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/ex11_tests/test_optimal_tree2.txt")
    tree = optimal_tree(records,["cough", "fever", "headache"],1)

    assert "fever" == tree.root.data or "headache" == tree.root.data

def test_optimal_tree3():
    records = parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/ex11_tests/test_optimal_tree3.txt")
    tree = optimal_tree(records, ["fever","cough","headache"],2)

    assert "influenza" == tree.root.positive_child.positive_child.data
    assert "meningitis" == tree.root.positive_child.negative_child.data
    assert "cold" == tree.root.negative_child.positive_child.data
    assert "healthy" == tree.root.negative_child.negative_child.data
