...
def test_build_tree():
    args_lst = [
        (parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/testssss/data2/tiny_data2.txt"), ["headache", "fever"]),
        (parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/testssss/data2/small_data1.txt"), ["headache", "fever"]),
        (parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/testssss/data2/medium_data1.txt"), ['fever', 'cough']),
        (parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/testssss/data2/medium_data2.txt"), ['fever', 'cough']),
        (parse_data("/Users/hyqmlwy/Desktop/intro/exercises/week11/ex11/testssss/data2/tiny_data3.txt"), [])
    ]
    expected_lst = [
...
def test_optimal_tree():
    data = lambda i: rf"data2/test_optimal_tree{i}.txt"
    args_lst = [
...
def test_optimal_tree_exeptions():
    records = parse_data(rf"data2/test_optimal_tree1.txt")
