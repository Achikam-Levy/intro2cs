...
BUTTON_STYLE = {"font":  ("Comic Sans MS", 20, "bold"),
                "borderwidth": 1,
                "relief": tk.RAISED,
                "bg": "DarkOrange3",
...
class BoggleGUI:
    ...
    def __init__(self, all_words):
        ...
        self.start_button = tk.Button(self.__tk_main, text="Start",
                                      font=("Courier", 20),  command=lambda: [
        ...
        self.start_button.bind("<Enter>", button_hover)
        self.start_button.bind("<Leave>", not_button_hover)
    ...
    def _click_renew_game(self):
        ...
        self._score_label = tk.Label(self.root, text=f"SCORE:{self.SCORE}",
                    font=("Courier", 15), bg="SkyBlue3").grid(row=0, column=0)
    ...
    def stop_button(self):
        ...
        if self.ROUND_COUNTER == 0:
            ...
            self.update()
            self.create_buttons_in_lower_frame(self.BOARD)
            self._check_word_button.config(
    ...
    def right_word(self, r):
        if r > 0:
            ...
            r -= 1
            self.root.after(150, lambda: self.right_word(r))
